...
<div>
  <h2 className='h2 mb-12'>Subscribe & Get Pet <br/> Updates - News</h2>
  <div className='flex relative'>
    <input type="text" className='bg-transparent border-b-2 placeholder:text-white text-white outline-none absolute w-full pr-12' placeholder='Mail' />
